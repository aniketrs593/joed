...
camera3_parameters = {'x': 0.15, 'y': 0.55, 'z': 1.65, 'roll': 0, 'pitch': -15, 'yaw': 45,
                      'width': 1024, 'height': 768, 'fov': 70,
                      'sensor_label': 'camera3', 'sensor_type': 'camera'}

camera4_parameters = {'x': -0.2, 'y': 0.55, 'z': 1.65, 'roll': 0, 'pitch': -20, 'yaw': 90,
                      'width': 1024, 'height': 768, 'fov': 70,
                      'sensor_label': 'camera4', 'sensor_type': 'camera'}

camera5_parameters = {'x': -0.6, 'y': 0.55, 'z': 1.65, 'roll': 0, 'pitch': -15, 'yaw': 135,
                      'width': 1024, 'height': 768, 'fov': 70,
                      'sensor_label': 'camera5', 'sensor_type': 'camera'}

camera6_parameters = {'x': -0.6, 'y': 0.00, 'z': 1.65, 'roll': 0, 'pitch': -5.0, 'yaw': 180,
                      'width': 1024, 'height': 768, 'fov': 70,
                      'sensor_label': 'camera6', 'sensor_type': 'camera'}

camera7_parameters = {'x': -0.6, 'y': -0.55, 'z': 1.65, 'roll': 0, 'pitch': -15, 'yaw': 225,
                      'width': 1024, 'height': 768, 'fov': 70,
                      'sensor_label': 'camera7', 'sensor_type': 'camera'}

camera8_parameters = {'x': -0.2, 'y': -0.55, 'z': 1.65, 'roll': 0, 'pitch': -20, 'yaw': 270,
                      'width': 1024, 'height': 768, 'fov': 70,
